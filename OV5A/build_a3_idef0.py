...
# ============================ INPUT F2 (left, branches to A32 & A33) ============================
seg(0.55,2.75,7.00,2.75)                                          # F2 input bus
path([(3.85,2.75),(3.85,3.70),(4.15,3.70)])                       # F2 -> A32 left
path([(7.00,2.75),(7.00,3.70),(7.25,3.70)])                       # F2 -> A33 left
add_label('F2 Local Micro-Weather State Estimate (IER-05)',
          0.40,2.28,1.80,0.44,10, fill_white=True)
...
prs.save('ATMOS_A3_IDEF0_native_vNext.pptx')
